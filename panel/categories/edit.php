...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="../../panel/categories/category.php">
          <i class="bi bi-person"></i>
          <span>Category</span>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="../../panel/categories/product.php">
          <i class="bi bi-question-circle"></i>
          <span>Product</span>
        </a>
      ...
      <div class="row">
        ...
        <form action="update.php" method="POST" enctype="multipart/form-data">    
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?php echo $row['title']; ?>" name="title" id="title" required>
