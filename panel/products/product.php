...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link " href="../../panel/products/product.php">
          <i class="bi bi-question-circle"></i>
          <span>Product</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="../coupon/coupon.php">
          <i class="bi bi-question-circle"></i>
          <span>Coupon</span>
        </a>
  ...
  <div class="modal-body">
    <form action="store_product.php" method="POST" enctype="multipart/form-data">    
      <div class="mb-3">
        ...
        <label for="category_id" class="form-label mt-2">Product Category</label>
      ...
      <div class="mb-3">
        ...
        <img id="current_image" src="" alt="Current Image" style="height: 100px; margin-top: 10px; display:none;">
       </div>
        ...
        if (mysqli_num_rows($products) > 0) {
            while ($product = $products->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td>
                            <a href='delete.php?product_id=".$product['product_id']."' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure you want to delete this product?\")'>Delete</a>
                            <a href='edit.php?id=".$product['product_id']."' class='btn btn-sm  btn-primary'>Edit</a>
                        </td>
                    </tr>";
            }
        } else {
