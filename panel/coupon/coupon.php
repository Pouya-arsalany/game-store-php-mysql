...
if(isset($_GET['search'])) {
  $search = $_GET['search'];
  $sql = "SELECT products.*, categories.title AS category_name
  FROM products
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <a href="../../../shopping website/index.php" class="logo d-flex align-items-center">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="get" action="product.php">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="../../panel/categories/index.php">
          <i class="bi bi-grid"></i>
          <span>category</span>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="../../panel/products/product.php">
          <i class="bi bi-question-circle"></i>
          <span>Product</span>
        </a>
      </li>
                ...
                <div class="modal-body">
                  <form action="store.php" method="POST">
                    <div class="mb-3">
                      ...
                      <label for="discount_type" class="form-label mt-2">Discount Type</label>
                      <select class="form-control" name="discount_type" id="discount_type" required>
                        <option value="fixed">Fixed</option>
                        <option value="percentage">Percentage</option>
                      </select>

                      <label for="discount_value" class="form-label mt-2">Discount Value</label>
                      <input type="text" class="form-control" name="discount_value" id="discount_value" required>

                      <label for="max_uses" class="form-label mt-2">Max Uses</label>
                      <input type="number" class="form-control" name="max_uses" id="max_uses" required>

                      <label for="expire_date" class="form-label mt-2">Expiry Date</label>
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($coupon = mysqli_fetch_assoc($result)) {
                        echo "<tr>
                                ...
                                <td>
                                    <a href='delete.php?coupon_id=".$coupon['coupon_id']."' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure you want to delete this coupon?\")'>Delete</a>
                                    <a href='edit.php?id=".$coupon['coupon_id']."' class='btn btn-sm btn-primary'>Edit</a>
                                </td>
                            </tr>";
                    }
                } else {
